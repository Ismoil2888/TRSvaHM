...
// import { faBars } from '@fortawesome/free-solid-svg-icons';
// import { RiTranslate2 } from "react-icons/ri";
// import { FcCollaboration, FcLibrary, FcPlanner } from "react-icons/fc";
// import { FiUser } from "react-icons/fi";
...
//             image={ttulogo} 
//             title="Высокий спрос" 
//             description="Специалисты по информационной безопасности, подготовленные у нас, востребованы на мировом рынке." 
//           />
//           <Card 
//             image={basiclogo} 
//             title="Практические навыки" 
//             description="Современные лаборатории и реальные проекты помогают освоить необходимые технологии." 
//           />
//           <Card 
//             image={ttulogo} 
//             title="Успешная карьера" 
//             description="Большинство наших выпускников работают в лидирующих компаниях мира." 
//           />
//           <Card 
//             image={ttulogo} 
//             title="Инновационные методики" 
//             description="Наши программы соответствуют последним мировым стандартам образования в ИБ." 
//           />
//         </div>
//       </div>
//     ),
...
//         <h2 style={{ color: "grey" }}>Бакалавриат</h2>
//         <p>
//           Наши бакалаврские программы – это комплексное образование, ориентированное на практику и инновации. Мы предлагаем учебные курсы, которые сочетают теорию с практическими заданиями, чтобы вы были готовы к современным требованиям рынка труда.
//         </p>
//         <div className="wp-cards-grid">
//           <Card 
//             image={basiclogo} 
//             title="Актуальные программы" 
//             description="Учебные курсы, разработанные в сотрудничестве с ведущими экспертами отрасли." 
//           />
//           <Card 
//             image={ttulogo} 
//             title="Практическое обучение" 
...
//             image={basiclogo} 
//             title="Перспективы карьеры" 
//             description="Выпускники нашего бакалавриата востребованы в различных сферах ИТ и бизнеса." 
//           />
//         </div>
//         {/* Блок с информацией о 5 кафедрах */}
//         <div className="departments-section" style={{ color: "purple" }}>
//           <h3>Наши кафедры факультета</h3>
//           <p>
//             Наш факультет обладает 5 кафедрами, каждая из которых специализируется на ключевых направлениях современной ИТ-образовательной программы:
//           </p>
//           <div className="departments-grid">
//             <div className="department-block">Системахои Автоматикунонидашудаи Идоракуни</div>
//             <div className="department-block">Шабакахои Алока Ва Системахои Комутатсиони</div>
//             <div className="department-block">Технологияхои Иттилооти Ва Хифзи Маълумот</div>
//             <div className="department-block">Автоматонии Равандхои Технологи Ва Истехсолот</div>
//             <div className="department-block">Информатика Ва Техникаи Хисоббарор</div>
//           </div>
//           <motion.div
//             className="signup-cta"
...
//         <h2 style={{ color: "grey" }}>Ҷадвали дарсҳо</h2>
//         <p>
//           Наш раздел расписания – это интуитивно понятный инструмент для планирования вашего учебного процесса. Всегда будьте в курсе всех новостей, уроков, преподавателей и расписания занятий, регистрируясь на нашей платформе!
//         </p>
//         <div className="wp-cards-grid">
//           <FcPlanner style={{ fontSize: "250px" }} />
//           <Card 
//             image={basiclogo} 
//             title="Удобное расписание" 
//             description="Интерактивное расписание позволяет легко планировать ваше время." 
//           />
//           <Card 
//             image={ttulogo} 
//             title="Актуальные обновления" 
//             description="Все изменения и новости мгновенно отображаются на платформе." 
//           />
//           <Card 
//             image={basiclogo} 
//             title="Простота использования" 
//             description="Дружелюбный интерфейс позволяет быстро находить нужную информацию." 
//           />
//         </div>
//       </div>
//     ),
...
//         <h2 style={{ color: "grey" }}>Китобхонаи электронӣ</h2>
//         <p>
//           Получите неограниченный доступ к богатейшей электронной библиотеке. Зарегистрировавшись на нашей платформе, вы сможете читать и скачивать множество интересных книг, учебных материалов и ресурсов, которые помогут вам в самообразовании и профессиональном росте.
//         </p>
//         <div className="wp-cards-grid">
//           <FcLibrary style={{ fontSize: "250px" }} />
//           <Card 
...
//         <h2 style={{ color: "grey" }}>Тамос</h2>
//         <p>
//           Если у вас возникли вопросы или нужна помощь – раздел «Тамос» всегда к вашим услугам. Свяжитесь с нашей службой поддержки, и мы оперативно ответим на все ваши запросы, чтобы вы могли сосредоточиться на учебе.
//         </p>
//         <div className="wp-cards-grid">
//           <FcCollaboration style={{ fontSize: "250px" }} />
//           <Card 
//             image={ttustudents3} 
//             title="Поддержка 24/7" 
//             description="Наша служба поддержки работает круглосуточно, чтобы помочь вам." 
//           />
//           <Card 
//             image={ttustudents3} 
//             title="Консультации экспертов" 
...
//             image={ttustudents3} 
//             title="Быстрый отклик" 
//             description="Оперативно отвечаем на все ваши вопросы и заявки." 
//           />
//         </div>
//       </div>
//     ),
...
//       {/* Блок вкладок и настройки для десктопа */}
//       <div className="hp-tabs">
//         <motion.ul
//           initial={{ opacity: 0, y: 20 }}
//           animate={{ opacity: 1, y: 0 }}
